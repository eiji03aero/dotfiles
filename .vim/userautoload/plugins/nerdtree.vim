...
call NERDTreeHighlightFile('hs',     '214',          'none', 'yellow',  '#151515')
...
call NERDTreeHighlightFile('json',   '214',          'none', 'yellow',  '#151515')
...
call NERDTreeHighlightFile('css',    '214',          'none', 'cyan',    '#151515')
...
call NERDTreeHighlightFile('coffee', '214',          'none', '#ffa500', '#151515')
call NERDTreeHighlightFile('ts',     '214',          'none', '#ffa500', '#151515')
call NERDTreeHighlightFile('tsx',    '214',          'none', '#ffa500', '#151515')
