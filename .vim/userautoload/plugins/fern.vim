...
function! s:fernHighlight(extension, fg, bg)
  exec 'autocmd User FernHighlight highlight ' . a:extension .' ctermbg='. a:bg .' ctermfg='. a:fg
  exec 'autocmd User FernHighlight syntax match ' . a:extension . ' /' . a:extension . '/'
  exec 'autocmd User FernSyntax highlight '. a:extension .' ctermbg='. a:bg .' ctermfg='. a:fg
  exec 'autocmd User FernSyntax syntax match '. a:extension .' /.*.'. a:extension .'/'
endfunction
...
call s:fernHighlight('Dockerfile', '248',          'none')
